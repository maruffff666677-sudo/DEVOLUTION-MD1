...
module.exports = {
    ...
    async run(m, { sock, plugins, config, Func }) {
        ...
        let caption = `Wᴇʟᴄᴏᴍᴇ @${m.sender.split('@')[0]} sᴀʏᴀ ᴅᴇᴠᴏʟᴜᴛɪᴏɴ sᴇʙᴜᴀʜ sᴄʀɪᴘᴛ ʙᴏᴛ ᴡʜᴀᴛ'sᴀᴘᴘ ʏᴀɴɢ ᴅɪ ᴋᴇᴍʙᴀɴɢᴋᴀɴ ᴏʟᴇʜ ᴛᴇᴀᴍ ʏᴀɴɢ ʜᴇʙᴀᴛ \`( ᴅᴇᴠᴏʟᴜᴛɪᴏɴ-ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ )\` ʏᴀɴɢ ᴛᴇʀᴅɪʀɪ ᴅᴀʀɪ 5 ᴏʀᴀɴɢ ʜᴇʙᴀᴛ. 
