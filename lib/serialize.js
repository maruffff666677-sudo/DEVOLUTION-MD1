...
module.exports = async(messages, sock, store) => {
    ...
    message: {
        extendedTextMessage: {
            text: 'Dᴇᴠᴏʟᴜᴛɪᴏɴ | ᴍᴅ',
            title: "Sᴇʟᴀᴍᴀᴛ ʜᴀʀɪ ɴᴀᴛᴀʟ",
            thumbnailUrl: "https://img101.pixhost.to/images/79/546467040_skyzopedia.jpg"
        }
    }
    }
        m.fverif = {
	...
	if (m.message) {
		...
		m.prefix = new RegExp('^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢+âœ“=|/~!?@#%^&.Â©^]', 'gi').test(m.body) ? m.body.match(new RegExp('^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢+âœ“=|/~!?@#%^&.Â©^]', 'gi'))[0] : '';
		...
		m.isPc = m.cht.endsWith('@s.whatsapp.net')
    ...
    let msg = {
      ...
      type: "append",
       ...
       return sock.ev.emit("messages.upsert", msg);
				...
				m.quoted.prefix = new RegExp('^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢+âœ“=|/~!?@#%^&.Â©^]', 'gi').test(m.quoted.body) ? m.quoted.body.match(new RegExp('^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢+âœ“=|/~!?@#%^&.Â©^]', 'gi'))[0] : '';
...
sock.sendMessage(m.cht, {
           ...
           fileName: `Dᴇᴠᴏʟᴜᴛɪᴏɴ | ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ`,
           fileLength: 99999999999999,
            mimetype: 'application/pdf',
           jpegThumbnail: fs.readFileSync(`./image/thumb.jpg`),
            caption: text,
  contextInfo: {
       showAdAttribution: true,
        ...
        businessMessageForwardInfo: {
            businessOwnerJid: `6282181938329@s.whatsapp.net`
        },
        forwardedNewsletterMessageInfo: {
            newsletterJid: config.idCh,
            serverMessageId: null,
            newsletterName: "1.0.6"
        }
    }
